                           ...
                           incsource, mortsource) 
{
  ...
  inc <- interpolate_cumsurv_mel(incidence_lungg, 
                             ratevar='Rate.Per.100K',
                             country=incsource,
                             maxage=maxIncAge)
  mort <- interpolate_cumsurv_mel(othercausemort_2017, 
                              ratevar='Rate.Per.100K',
                              country=mortsource)
  ...
  # stagecreate_pop_list() function, and that would work with
...
compile_naturalhist_lung1 <- function(prop_adv, mortrates, subgroup_probs) {
